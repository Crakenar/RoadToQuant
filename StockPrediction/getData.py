...
def getAlphaAvantageDataFromApi():
    # ====================== Loading Data from Alpha Vantage ==================================

    api_key = 'LYYXOPSIZOM0YMAS'
...
def get_data():
    if data_source == 'alphavantage':
       getAlphaAvantageDataFromApi()
        ...
        print(all_mid_data)
        normal_averaging(train_data, df, all_mid_data)
        exponential_moving_average(train_data, df, all_mid_data)
